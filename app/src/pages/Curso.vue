...
<div v-if='informacoes' >
 ...
 <q-chip color="primary" outline :icon="informacoes['O que você deseja divulgar?'] == 'Curso' ? 'school' : 'celebration'" >{{informacoes['O que você deseja divulgar?']}}</q-chip>
      <q-chip color="primary" outline :icon="informacoes.Modalidade == 'Online' ? 'public' : 'location_city'" >{{informacoes.Modalidade}}</q-chip>
        ...
        <q-chip color="orange" outline  icon="people" > <div class="chip">{{informacoes['Público alvo']}}</div> </q-chip>
      </div>
...
<div class='text-h6 text-center q-pa-xl' >
  <p v-if='informacoes["Página/link de Inscrições (se houver)"] != ""'>Página para inscrição: {{informacoes['Página/link de Inscrições (se houver)']}}</p>
  <p v-if='informacoes["E-mail de contato para inscrições (se houver)"] != ""'>Email sobre inscrições {{informacoes['E-mail de contato para inscrições (se houver)']}}</p>
  <p v-if='informacoes["E-mail de contato para inscrições (se houver)"] != ""'>Email sobre inscrições {{informacoes['E-mail de contato para inscrições (se houver)']}}</p>
