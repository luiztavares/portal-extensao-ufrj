...
<div v-if='informacoes' >
  <q-page >
    <q-img  height='70vh' fit='cover' src='https://constructapp.io/wp-content/uploads/2017/02/saiba-diferenciar-projeto-projeto-basico-e-projeto-executivo.jpg'>
...
export default defineComponent({
  ...
  methods: {
    getProjetos() {
      ...
      const url = "http://127.0.0.1:8000/projetos/"+ this.id + '/'
      console.log(url)
