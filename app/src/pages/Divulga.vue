<template>
  <q-page class='q-ma-xl  justify-center'>
      ...
      <p class="text-h4 text-center">Solicite aqui a divulgação da sua ação de extensão no Portal da Extensão UFRJ e nas redes
sociais da Pró-Reitoria de Extensão.</p>
    ...
    <p class="text-h6">Em caso de dúvida ou outro tipo de solicitação, encaminhe ao e-mail  </p>
    <p class="text-h6"><a href="mailto:pr5comunicacaoinstitucional@gmail.com">pr5comunicacaoinstitucional@gmail.com</a>  </p>
         </div>
