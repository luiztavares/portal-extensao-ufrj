    ...
    <div v-if="$q.screen.lt.md" class="col-xs-12 col-md-3">
      ...
      >
        <q-list bordered padding class="radius16">
          ...
          <q-input
            class="q-pa-md"
            v-model="acoesStore.filters.pesquisa.value"
            rounded
            outlined
            type="search"
          ...
          <q-expansion-item
            ...
            icon="category"
            label="Datas"
            caption="Período de realização ou inscrição da ação"
            header-class="text-white bg-blue"
            expand-icon-class="text-white"
            v-model="flagInscricao"
          >
            <q-card>
              <q-card-section>
                <q-item
                  v-for="item in acoesStore.filters.inscricoes.options"
                  :key="item.label"
                  v-ripple
                >
                  <q-item-section side top>
                    <q-checkbox
                      v-model="acoesStore.filters.inscricoes.select"
                      :val="item.value"
                      color="blue"
                    />
                  </q-item-section>
          ...
          <q-expansion-item
            ...
            icon="category"
            label="Categoria"
            caption="Tipo da ação ofertada"
            header-class="text-white bg-purple"
            expand-icon-class="text-white"
            v-model="flagCategoria"
          >
            <q-card>
              <q-card-section>
                <q-item
                  v-for="item in acoesStore.filters.tipo.options"
                  :key="item.label"
                  v-ripple
                >
                  <q-item-section side top>
                    <q-checkbox
                      v-model="acoesStore.filters.tipo.select"
                      :val="item.value"
                      color="purple"
                    />
                  </q-item-section>
          ...
          <q-expansion-item
            ...
            icon="category"
            label="Modalidade"
            caption="Modalidade da ação"
            header-class="text-white bg-teal"
            expand-icon-class="text-white"
            v-model="flagModalidade"
          >
            <q-card>
              <q-card-section>
                <q-item
                  v-for="item in acoesStore.filters.modalidade.options"
                  :key="item.label"
                  v-ripple
                >
                  <q-item-section side top>
                    <q-checkbox
                      v-model="acoesStore.filters.modalidade.select"
                      :val="item.value"
                      color="teal"
                    />
                  </q-item-section>
