<template>
  <q-page
    class="bg-white q-pa-xs-sm q-pa-md-xl q-pt-xl row q-px-md q-pb-xl maxwidth"
  >
    ...
    <div class="col-md-9 col-xs-12 row justify-center">
      ...
      <q-list bordered expand-separator class="rounded-borders">
        ...
        >
          <q-card
            class="q-pa-md-xl header2"
            style="border-top-style: solid; border-color: #8640c4"
          >
            <q-card-section class="row">
              <div class="col-md-4 col-sm-12 q-pb-md">
                <span class="header2">Modalidade: {{ curso.modalidade }}</span
                ><br />
                <span class="text1 q-pl-md">
                  Coordenador:
                  {{ curso.coordenador_da_acao_de_extensao }} </span
                ><br />
                <span class="text1 q-pl-md">Contato: {{ curso.Contato }}</span
                ><br />
                <span class="text1 q-pl-md">Centro: {{ curso.centro }}</span
                ><br />
                <span class="text1 q-pl-md">Unidade: {{ curso.unidade }}</span
                ><br />
                <span class="text1 q-pl-md">
                  Links de redes:
                  {{ curso.links_para_redes_sociaus_e_sites }} </span
                ><br />
                <a
                  class="text1 q-pl-md"
                  :href="
      ...
      <div
        v-if="$q.screen.lt.md"
        class="q-mt-md col-md-12 col-sm-11 row justify-center"
      >
        <q-btn
          target="_blank"
          href="https://portal.ufrj.br/Inscricao/extensao/acaoExtensao/filtro;jsessionid=1UbC2vZysfPGK9HCWNdbdw__.inscricao-687668dd68-4gdnj"
        ...
        >
          ...
          <span class="q-px-md col text-h6" style="color: #8640c4"
            >Consulte as ações ativas diretamente no SIGA da UFRJ</span
          >
        </q-btn>
      </div>
    </div>
